...
BACTERIA_SPECIES <- c( "MT_H37", "H37Rv1", "Msmeg_mc2_155", "Styph", "Mchel", "Mabsc", "Mavium", "MT_HN878", "BCG", "Mmar","Otsu")
BACTERIA_PREFIXES <- c( "MTb", "H37Rv1", "Msmeg", "Styph", "Mchel", "Mabsc", "Mavium", "MTbHN878", "BCG", "Mmar","Otsu")
